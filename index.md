...
address: "Deutscher Pl. 6, Leipzig, Germany 604103"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "51.3397"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "12.3714"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Nov. 24-28, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 12:00 pm CEST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-11-24      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-11-28        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Bret Beheim", "Connor Davis", "Alejandra Ramírez", "Peeter Tinits"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Alfredo Cortell-Nicolau"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "1759334971259"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
